...
#
# Generated by export_simulation on Tue Mar 18 10:09:04 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './rom6.sh' script.
...
./rom6.sh -noclean_files

For more information on the script, please type './rom6.sh -help'.
