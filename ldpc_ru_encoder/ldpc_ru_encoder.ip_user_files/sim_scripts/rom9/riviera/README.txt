...
#
# Generated by export_simulation on Tue Mar 11 09:41:30 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './rom9.sh' script.
...
./rom9.sh -noclean_files

For more information on the script, please type './rom9.sh -help'.
