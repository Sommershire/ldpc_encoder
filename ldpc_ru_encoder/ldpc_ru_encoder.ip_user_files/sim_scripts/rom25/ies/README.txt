...
#
# Generated by export_simulation on Tue Mar 11 14:16:26 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './rom25.sh' script.
...
./rom25.sh -noclean_files

For more information on the script, please type './rom25.sh -help'.
