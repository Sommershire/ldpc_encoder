...
#
# Generated by export_simulation on Tue Mar 18 10:08:36 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './rom20.sh' script.
...
./rom20.sh -noclean_files

For more information on the script, please type './rom20.sh -help'.
