...
#
# Generated by export_simulation on Tue Mar 18 10:09:00 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './rom8.sh' script.
...
./rom8.sh -noclean_files

For more information on the script, please type './rom8.sh -help'.
